...
export function Button({
  ...
  return (
    <button
      className={`inline-flex max-w-full items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 sm:py-2 ${variants[variant]} ${className}`}
      {...props}
    >
      {children}
    </button>
